...
})({"klKs0":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4cc37706f0933d7e";
module.bundle.HMR_BUNDLE_ID = "463de6749d082bcb";
"use strict";
...
},{"./modals.js":"3c6ls","@parcel/transformer-js/src/esmodule-helpers.js":"fLZXY"}],"3c6ls":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
//------------------------------------------------------------------------
'use strict';
class Modal extends _evEmitterDefault.default {
    constructor(el1, opts){
    ...
    open(evt) {
        ...
        // Disable scrolling
        _freezeScrollDefault.default.freeze();
    ...
    close(evt) {
        ...
        // Enable scrolling
        _freezeScrollDefault.default.unfreeze();
...
},{"@threespot/freeze-scroll":"8Lztc","ev-emitter":"kqwHB","@parcel/transformer-js/src/esmodule-helpers.js":"fLZXY"}],"8Lztc":[function(require,module,exports) {
...
},{}],"kqwHB":[function(require,module,exports) {
...
},{}],"fLZXY":[function(require,module,exports) {
...
},{}],"3KI92":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
// initiate lunr
let idx = _lunrDefault.default(function() {
    this.ref('id');
    this.field('content', {
        boost: 10
    });
...
filter.addEventListener('submit', (event)=>{
    ...
    options = options.filter((option)=>option !== "on" && option != "location" && option.length
    ).map((option)=>{
...
},{"lunr":"1jIqv","@parcel/transformer-js/src/esmodule-helpers.js":"fLZXY"}],"1jIqv":[function(require,module,exports) {
(function() {
    /**
 ...
 */ lunr.stemmer = (function() {
        ...
        var porterStemmer = function porterStemmer1(w) {
 ...
 */ lunr.Index.load = function(serializedIndex) {
        ...
        }, serializedVectors = serializedIndex.fieldVectors, invertedIndex = Object.create(null), serializedInvertedIndex = serializedIndex.invertedIndex, tokenSetBuilder = new lunr.TokenSet.Builder, pipeline = lunr.Pipeline.load(serializedIndex.pipeline);
 ...
 */ lunr.Builder.prototype.calculateAverageFieldLengths = function() {
        var fieldRefs = Object.keys(this.fieldLengths), numberOfFields = fieldRefs.length, accumulator = {
        }, documentsWithField = {
        };
 ...
 */ lunr.Builder.prototype.createFieldVectors = function() {
        var fieldVectors = {
        }, fieldRefs = Object.keys(this.fieldTermFrequencies), fieldRefsLength = fieldRefs.length, termIdfCache = Object.create(null);
...
},{}]},["klKs0","hD45X"], "hD45X", "parcelRequire7bfb")
