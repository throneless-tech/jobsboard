...
})({"iu1fH":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "6a16634702c2165c";
module.bundle.HMR_BUNDLE_ID = "c46cf7dced152d2e";
"use strict";
...
},{}],"fEf88":[function(require,module,exports) {
var _modalJs = require("./modal.js");
var _searchJs = require("./search.js");

},{"./modal.js":"eL5zp","./search.js":"2D3ya"}],"eL5zp":[function(require,module,exports) {
...
},{"./modals.js":"6aV4O","@parcel/transformer-js/src/esmodule-helpers.js":"80xja"}],"6aV4O":[function(require,module,exports) {
...
},{"@threespot/freeze-scroll":"5w2Vo","ev-emitter":"fzPQl","@parcel/transformer-js/src/esmodule-helpers.js":"80xja"}],"5w2Vo":[function(require,module,exports) {
...
},{}],"fzPQl":[function(require,module,exports) {
/**
 * EvEmitter v1.1.0
 * Lil' event emitter
 * MIT License
...
},{}],"80xja":[function(require,module,exports) {
...
},{}],"2D3ya":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
var bigram = function(builder) {
    ...
    (0, _lunrDefault.default).Pipeline.registerFunction(pipelineFunction, "bigram");
    // Add the pipeline function to both the indexing pipeline and the
    // searching pipeline
    builder.pipeline.before((0, _lunrDefault.default).stemmer, pipelineFunction);
    builder.searchPipeline.before((0, _lunrDefault.default).stemmer, pipelineFunction);
};
var metadataUpdate = function(builder) {
    ...
    // Register the pipeline function so the index can be serialised
    (0, _lunrDefault.default).Pipeline.registerFunction(pipelineFunction, "metadataUpdate");
...
searchbar.addEventListener("input", (event1)=>{
    ...
    let results = idx.search(`${event1.target.value}^100 ${event1.target.value}*^10 ${event1.target.value}~2`);
...
filter.addEventListener("submit", (event1)=>{
    event1.preventDefault();
    loadButton.classList.add("hidden");
...
clearButton.addEventListener("click", (event1)=>{
    filter.reset();
...
loadButton.addEventListener("click", (event1)=>{
...
},{"lunr":"9Naep","@parcel/transformer-js/src/esmodule-helpers.js":"80xja"}],"9Naep":[function(require,module,exports) {
(function() {
    /**
...
},{}]},["iu1fH","fEf88"], "fEf88", "parcelRequire7bfb")
